 ...
 *
 * Copyright 2026 "Querqy for OpenSearch" Developers
 *
...
public class RegexReplaceRewriterFactory  extends OpenSearchRewriterFactory {
    ...
    @Override
    public void configure(final Map<String, Object> config) throws OpenSearchException {
    ...
    @Override
    public RewriterFactory createRewriterFactory(final IndexShard indexShard) throws OpenSearchException {
        return delegate;
    }
}
